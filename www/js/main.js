var app = {
    ...
    init: function(ev) {
        ...
        document.querySelector(".back").addEventListener("click", app.popPop);
        document.querySelector(".back").addEventListener("click", app.navigate);
        document.querySelector(".back").setAttribute("data-href", "#listview");
        document.querySelector(".back").setAttribute("data-href", "#readreview")
